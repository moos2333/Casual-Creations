...
public class ContainerDiamondAnvil extends Container {
    ...
    public ContainerDiamondAnvil(InventoryPlayer playerInv, TileEntityDiamondAnvil te, World world, EntityPlayer player) {
        ...
        this.inputSlots = new InventoryBasic("Repair", true, 2) {
            ...
            public void markDirty() {
                super.markDirty();
                ContainerDiamondAnvil.this.onCraftMatrixChanged(this);
            }
        };
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
            ...
            public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack) {
                te.damage(1);
                ContainerDiamondAnvil.this.inputSlots.setInventorySlotContents(0, ItemStack.EMPTY);
                if (ContainerDiamondAnvil.this.materialCost > 0) {
                    ItemStack itemstack = ContainerDiamondAnvil.this.inputSlots.getStackInSlot(1);
                    if (!itemstack.isEmpty() && itemstack.getCount() > ContainerDiamondAnvil.this.materialCost) {
                        itemstack.shrink(ContainerDiamondAnvil.this.materialCost);
                        ContainerDiamondAnvil.this.inputSlots.setInventorySlotContents(1, itemstack);
                    } else {
                        ContainerDiamondAnvil.this.inputSlots.setInventorySlotContents(1, ItemStack.EMPTY);
                    }
                } else {
                    ContainerDiamondAnvil.this.inputSlots.setInventorySlotContents(1, ItemStack.EMPTY);
                }
                ContainerDiamondAnvil.this.maximumCost = 0;
                return stack;
            }
        });
